        ...
        <footer class="site-footer footer-two">
			...
			<svg class="d-none d-lg-block z-index-3 custom-svg-position-1 wow fadeInDown" data-wow-delay="520ms" data-wow-duration="2500ms" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1686.88 1095.86" data-appear-animation-svg="true">

							<path class="appear-animation wow fadeInUp" data-plugin-options="{'accY': -500, 'forceAnimation': true}" data-appear-animation="customLines1anim" data-appear-animation-delay="100" data-appear-animation-duration="7s" fill="none" stroke="#d8d8d8" stroke-width="2px" stroke-miterlimit="10" d="M87.95,1.4c6.82,9.14,15.53,21.59,24.68,36.94c6.82,11.45,27.18,46.82,42.55,96.51
							...
							<path class="appear-animation wow fadeInDown" data-plugin-options="{'accY': -500, 'forceAnimation': true}" data-appear-animation="customLines1anim" data-appear-animation-delay="100" data-appear-animation-duration="7s" fill="none" stroke="#d8d8d8" stroke-width="2px" stroke-miterlimit="10" d="M208.89,133.57c7.42,9.37,15.01,20.15,22.21,32.43c21.75,37.04,29.38,69.66,33.96,89.87
                            ...
                            <div class="title-line">
                                ...
                                <h3>Usefull Links</h3>
									...
									<li><a href="index.php">Home</a></li>
                                        ...
                                        <li  class=""> <a href="patny-perforated-cable-trays-pct.php">Patny  Cable Trays  </a></li>  

                                         <li><a href="c-purlin.php">Solar module structure</a></li> 
                            ...
                            <div class="post-wrapper">
                                ...
                                <div class="single-post-content">
                                    ...
                                    <div class="text-block">
                                            ...
                                            <a href="#" class="date-line" id="rdg">  Regd. Office</a>

                                        <h3> <i class="fa fa-map-marker"></i>  <a href="#">160, Patny Plaza, Sardar Patel Road, Secunderabad – 500 003</a></h3>

										<p style="color:#fff; margin-top:15px;"><i class="fa fa-phone"></i>  <span class="text-line">+91-99480 81000/ +91-99480 91000</span></p>

										<p style="color:#fff; margin-top:15px;"><i class="fa fa-phone"></i>  <span class="text-line">040-27905154/ 27901119, Fax: 040 - 27902451</span></p>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="newsletter-wrapper">
                                ...
                                <p>PATNY SYSTEMS PVT LTD an ISO 9001-2015 certified company, takes this opportunity to introduce ourselves as one of the leading manufacturers cable Trays, Grating, Solar structures and earthing material for 35+ years. We are reputed as Cable Tray Manufacturers & leading industry with superior quality, time bound dispatches and systematic approach.</p>
        ...
        <div class="footer-bottom-home-two">
            ...
            <div class="container clearfix">
                ...
                <div class="left-content float-left">
                    ...
                    <p>&copy; 2022 All Rights Reserved by <a href="#">PATNY SYSTEMS PVT LTD .</a></p>

                </div><!-- /.left-content -->

                <div class="right-content float-right">

                     <p>Web Designers <a href="https://vstechnosolutions.com" target="_blank">VS Techno Solutions</a></p>
...
<script>
  grecaptcha.ready(function() {
      grecaptcha.execute('6LfkdGIhAAAAAJcSIPRer2YMHAxD18rjVHBkgPwd', {action: 'homepage'}).then(function(token) {
          console.log(token);
...
<!--Live Chat Code-->
<script async src="https://backend.livhousing.com/bot/create-script-tag?token=57eb56d6-e8ac-40a9-8786-c0fabf72afa1" type="application/javascript"></script>
<!--Live Chat Code-->
